...
Okay, lets first create a dataset with a unique PersonID and a column confirming that they graduated from a post secondary institution.
...
The table below shows that the number of individuals that graduated from a post-secondary institution was nearly half - 48%.
