...
The table below shows that of the total graduates from Northeast high schools, nearly a third (30%) were a CTE concentrator or completor, while 27% were just a participant and 43% took no CTE courses at all.
...
The cross-tabs show a significant difference between the percentage of students by categorization and RUCA categories. Our The more rural the district, the higher the percentages of the graduates that are either concentrators or completors, or took at least one CTE course.
...
Interestingly, these are going in opposite directions. CTE concentrators or completors has been setadily decreasing since 2008 - from 50% to 21%.

CTE participants has increased a bit going from 19% to 32%.

The percentage of graduating taking no CTE courses has increased, going from 31% to 47%.
