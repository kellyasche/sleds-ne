...
cte.demographics.original <- read_csv('/Users/kellyasche/Library/CloudStorage/GoogleDrive-kasche@ruralmn.org/My Drive/Research/FY25-27/FY27/OHE Journey to meaningful employment/Data/SLEDS/CTEDemographics/CTEDemographic.csv')  %>%
...
The table below shows that of the total graduates from Northeast high schools, nearly a third (31%) were a CTE concentrator or completor, while 28% were just a participant and 42% took no CTE courses at all.
...
The cross-tabs show a significant difference between the percentage of students by categorization and RUCA categories. The more rural the district, the higher the percentages of the graduates that are either concentrators or completors, or took at least one CTE course.
...
The cross tabulations show that there is a statistically significant difference in the percent of graduates in each CTE category by county. The map confirms that the more rural counties typically have a higher percentage of graduates that either concentrated or participated in CTE. The higher percentage of graduates that had no CTE were St. Louis County districts.
...
Interestingly, the percentage of graduates that had no CTE were hovering around 50% until 2020 when it completely flipped. This may indicate a change in CTE offerings at some of these schools during that time.
