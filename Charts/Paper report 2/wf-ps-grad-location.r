...
ggplot(data, aes(grad.year.5, pct, fill = ps.grad.location, group = ps.grad.location)) +
  ...
  labs(x="", 
       ...
       subtitle = "Graduating in the region significantly increases the liklihood of\nsustained workforce participation in the region.")+
  scale_y_continuous(labels=scales::percent) +
  theme_bar+
  scale_fill_manual(values = c("#006d2c", "#2ca25f", "#b2e2e2")) +
  theme(legend.position = "bottom",
        legend.box.margin = margin(-20, 0, 0, 0),
        text = element_text(size = 14),
        axis.text.x = element_text(angle = 25, hjust = .9))

ggsave(filename = "Charts/Paper report 2/wf-ps-grad-location.pdf", device = cairo_pdf, dpi = "print", width = 6, height = 4.5)

ggsave(filename = "Charts/Paper report 2/wf-ps-grad-location.png", dpi = "print", width = 6, height = 4.5)
