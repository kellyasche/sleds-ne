...
ggplot(regions) +
  ...
  theme_sf+
  labs(title= "Central project regions",
       subtitle = "Northeast is EDR 3") +
  theme(legend.position = "bottom",
        text = element_text(size = 16))

ggsave(filename = "Charts/Presentations/northeast-project-region-map.pdf", device = cairo_pdf, dpi = "print", width = 8.5, height = 6.5)
