...
dumbbell_data <- tibble(
  characteristic = c(
    ...
    "Special Education Status\n(vs. No Special Education)"
  ),
  baseline_pct = c(
    amp(model3_dv2, master.model.dv2, "RaceEthnicity", "White"),
    amp(model3_dv2, master.model.dv2, "RaceEthnicity", "White"),
    amp(model3_dv2, master.model.dv2, "RaceEthnicity", "White"),
    amp(model3_dv2, master.model.dv2, "RaceEthnicity", "White"),
    amp(model3_dv2, master.model.dv2, "SpecialEdStatus", "0")
  ),
  higher_pct = c(
    amp(model3_dv2, master.model.dv2, "RaceEthnicity", "AI"),
    amp(model3_dv2, master.model.dv2, "RaceEthnicity", "Black"),
    amp(model3_dv2, master.model.dv2, "RaceEthnicity", "Hispanic"),
    amp(model3_dv2, master.model.dv2, "RaceEthnicity", "Asian/PI"),
    amp(model3_dv2, master.model.dv2, "SpecialEdStatus", "1")
  )
) %>%
  mutate(
...
ggplot(dumbbell_data, aes(y = characteristic)) +
  ...
  labs(
    x = "Predicted likelihood of completing a postsecondary credential",
    y = NULL,
    title = "Predicted Likelihood of Completing a Postsecondary Credential\nby Selected Characteristics",
    subtitle = "The same characteristics associated with elevated disconnection risk are also\nassociated with lower odds of completing a postsecondary credential."
  ) +
  theme_bar +
  theme(legend.position = "bottom",
        axis.title = element_text(size = 7))

ggsave(filename = "Charts/Draft 5/no-ps-grad-characteristics.pdf", device = cairo_pdf, dpi = "print", width = 6, height = 5)

ggsave(filename = "Charts/Draft 5/no-ps-grad-characteristics.png", dpi = "print", width = 6, height = 5)
