...
ggplot(data, aes(grad.year.5, pct, fill = ps.grad.InstitutionSector, group = ps.grad.InstitutionSector)) +
  ...
  annotate(geom = "label",
           x = 2,
           y = .4,
           label = "2-year colleges increases\nparticipation in region",
           size = 3) +
  labs(x="", y = "", title = "Share of college grad type by workforce state 5 years\nafter graduating high school")+
...
ggsave(filename = "Charts/Paper report/college-type-regional-wf.pdf", device = cairo_pdf, dpi = "print", width = 6, height = 4.5)

ggsave(filename = "Charts/Paper report/college-type-regional-wf.png", dpi = "print", width = 6, height = 4.5)
