...
ggplot(
  ...
  labs(x = "", 
       y = "",
       title = "Limited CTE Engagement and Weaker Labor Force Attachment",
       subtitle = "Individuals with limited CTE exposure are more frequently represented among\nnon-meaningful and missing Minnesota workforce participation outcomes") +
  theme_all +
  theme(legend.position = "none")

ggsave(filename = "Charts/Paper report/sankey-cte-acheivement-non-sustained-wf.pdf", device = cairo_pdf, dpi = "print", width = 6, height = 4.5)

ggsave(filename = "Charts/Paper report/sankey-cte-acheivement-non-sustained-wf.png", dpi = "print", width = 6, height = 4.5)
