...
ggplot(data = filter(data, grad.year.5 == "Any weak connection"), aes(cte.achievement, pct, fill = cte.achievement)) +
  ...
  labs(x="",
       ...
       subtitle = "Low CTE engagement is associated with higher risk of weak workforce connection")+
  scale_y_continuous(labels=scales::percent) +
  theme_bar+
  scale_fill_manual(values = c("#018571", "#80cdc1", "#a6611a")) +
  theme(legend.position = "none")


ggsave(filename = "Charts/Paper report/pct-cte-achievement-any-weak-connection-wf.pdf", device = cairo_pdf, dpi = "print", width = 6, height = 4.5)

ggsave(filename = "Charts/Paper report/pct-cte-achievement-any-weak-connection-wf.png", dpi = "print", width = 6, height = 4.5)
