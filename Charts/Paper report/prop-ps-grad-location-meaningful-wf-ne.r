...
ggsave(filename = "Charts/Paper report/prop-ps-grad-location-meaningful-wf-ne.pdf", device = cairo_pdf, dpi = "print", width = 6, height = 4.5)

ggsave(filename = "Charts/Paper report/prop-ps-grad-location-meaningful-wf-ne.png", dpi = "print", width = 6, height = 4.5)
