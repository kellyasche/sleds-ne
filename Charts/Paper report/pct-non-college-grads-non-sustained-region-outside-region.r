...
ggplot(data, aes(after.ed.5.new, pct, fill = after.ed.5.new)) +
  ...
  labs(x="", 
       y = "", 
       title = "Location of non-sustained workforce participation, five years after formal\neducation",
       subtitle = "Most non-sustained employment among non-college graduates occurs within the region")+
...
ggsave(filename = "Charts/Paper report/pct-non-college-grads-non-sustained-region-outside-region.pdf", device = cairo_pdf, dpi = "print", width = 6.5, height = 4)

ggsave(filename = "Charts/Paper report/pct-non-college-grads-non-sustained-region-outside-region.png", dpi = "print", width = 6.5, height = 4)
