...
ggplot(
  ...
  labs(x = "", 
       y = "",
       title = "Completed college in Minnesota, but outside the region, by CTE\nAchievement",
       subtitle = "The less engaged an individual is in CTE, the higher the proportion of individuals will\ncomplete college in MN but outside the region") +
  theme_all +
  theme(legend.position = "none")


ggsave(filename = "Charts/Paper report/sankey-cte-acheivement-mn-college.pdf", device = cairo_pdf, dpi = "print", width = 6.5, height = 4.5)

ggsave(filename = "Charts/Paper report/sankey-cte-acheivement-mn-college.png", dpi = "print", width = 6.5, height = 4.5)
