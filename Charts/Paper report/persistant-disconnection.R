...
ggplot(data, aes(disconnected.cat, pct, fill = disconnected.cat)) +
  ...
  labs(x="", 
       y = "", 
       title = "Percent of non-college grads that ", caption = "\nCenter for Rural Policy and Development - Childcare Initiative Survey")+
  scale_y_continuous(labels=scales::percent) +
  theme_bar+
  scale_fill_manual(values = c("#009933", "#754C29", "#754C29", "#754C29"),
