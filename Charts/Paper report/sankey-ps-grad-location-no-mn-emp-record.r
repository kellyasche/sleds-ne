...
ggplot(
  ...
  labs(x = "", 
       ...
       subtitle = "Graduation location is strongly associated with not having a Minnesota employment record") +
  theme_all +
  theme(legend.position = "none",
        text = element_text(size = 10))

ggsave(filename = "Charts/Paper report/sankey-ps-grad-location-no-mn-emp-record.pdf", device = cairo_pdf, dpi = "print", width = 6.5, height = 4.5)

ggsave(filename = "Charts/Paper report/sankey-ps-grad-location-no-mn-emp-record.png", dpi = "print", width = 6.5, height = 4.5)
