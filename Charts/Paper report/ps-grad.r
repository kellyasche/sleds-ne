...
# Create chart ------------------------------------------------------------
ggplot(data = data, aes(ps.grad, pct, fill = ps.grad)) +
  ...
  labs(x="", 
       y = "", 
       title = "Percent of Northeast high school graduates that complete\ncollege",
       subtitle = "") +
...
ggsave(filename = "Charts/Paper report/ps-grad.pdf", device = cairo_pdf, dpi = "print", width = 6.5, height = 4.5)

ggsave(filename = "Charts/Paper report/ps-grad.png", dpi = "print", width = 6.5, height = 4.5)
