...
ggplot(
  ...
  labs(x = "", 
       y = "",
       title = "Workforce participation outcomes five years after high school, by location\nof postsecondary graduation",
       subtitle = "Graduation location is strongly associated with regional workforce attachment") +
  theme_all +
  theme(legend.position = "none")

ggsave(filename = "Charts/Paper report/sankey-ps-grad-location-meaningful-wf-ne.pdf", device = cairo_pdf, dpi = "print", width = 6.5, height = 4.5)

ggsave(filename = "Charts/Paper report/sankey-ps-grad-location-meaningful-wf-ne.png", dpi = "print", width = 6.5, height = 4.5)
