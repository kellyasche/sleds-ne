...
ggplot(data, aes(ps.grad.location, pct, fill = ps.grad.location)) +
  ...
  labs(x="", 
       y = "", 
       title = "Percent of college completers by location of institution", 
       subtitle = "A large majority of Northeast high school graduates complete their post-secondary\neducation in the region.")+
  scale_y_continuous(labels=scales::percent) +
  theme_bar+
  scale_fill_manual(values = c("#012623", "#2E7C63", "#8B601F")) +
  theme(legend.position = "none")


ggsave(filename = "Charts/Paper report 3/pct-ps-grad-location.pdf", device = cairo_pdf, dpi = "print", width = 6, height = 4)

ggsave(filename = "Charts/Paper report 3/pct-ps-grad-location.png", dpi = "print", width = 6, height = 4)
