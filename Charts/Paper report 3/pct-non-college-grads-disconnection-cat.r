...
ggplot(data, aes(disconnected.cat, pct, fill = disconnected.cat)) +
  ...
  scale_x_discrete(labels = c("Consistently\nattached", "Intermittently\ndisconnected", "Broadly\ndisconnected", "Persistently\ndisconnected")) +
  theme_bar+
  scale_fill_manual(values = c("#012623", "#2E7C63", "#8B601F", "#9B3F24"),
                    guide = guide_legend(ncol = 2)) +
  theme(legend.position = "none")

ggsave(filename = "Charts/Paper report 3/pct-non-college-grads-disconnection-cat.pdf", device = cairo_pdf, dpi = "print", width = 6, height = 4)

ggsave(filename = "Charts/Paper report 3/pct-non-college-grads-disconnection-cat.png", dpi = "print", width = 6, height = 4)
