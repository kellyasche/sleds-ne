...
grad.emp.location.match <- grad.locations %>%
  ...
  mutate(county.match = ifelse(employment.county == hs.county.name, 1,
         ...
         region.match = ifelse(emp.pr %in% c("Northeast"), 1,
                               ifelse(emp.edr == "Unknown", 0, -1)),
         state.match = 1) %>% 
...
careercluster.naics.cw <- read_xlsx('/Users/kellyasche/Library/CloudStorage/GoogleDrive-kasche@ruralmn.org/My Drive/Research/FY25-27/FY27/OHE Journey to meaningful employment/Data/SLEDS/Employment/career-cluster-naics.xlsx') %>%
...
It shows that 79% of the individuals had a MN employment record at their graduation year. That percentage drops to 68% two years after graduation and only 40% had a MN employment record 7 years after graduation. This small percentage is due to over half of the individuals would be after 2023 (last year of data available) at 7 years after graduation. The individuals with no MN employment record either means they are not working that year or are in another state.
...
The table below shows that the percentage of individuals working meaningful employment peaked grows significantly as the years after graduation progress. By 7 years after graduating, 59% have meaningful employment. The percentage of individuals with no MN employment record grows as well - it's 29% of all individuals by seven years after graduating.
...
The table below shows that 17% of the individuals in the master dataset had meaningful employment in the same county as their high school the year they graduated. It increased to 25% two years after graduation and then 29% seven years after graduation. These percentages are after filtering out all of the "After 2023" category.
...
- hs.grad.year: The more rural the high school, the slightly lower percentage of graduates have meaningful employment in the same county.
- hs.grad.year.2: The same as above, but the gap is getting larger: urban/town/rural mix graduates had 27% with meaningful employment in the same county compared to just 20% for entirely rural schools.
- hs.grad.year.7: The gap continues to grow: urban/town/rural mix schools had 32% with meaningful employment in their county compared to 19% in for entirely rural.
...
The chart below shows that 19% of individuals in the main dataset had meaningful employment in the region.. The percent increases to 29.9% of individuals two years after graduating and 37.3% seven years after graduation. All "After 2023" individuals were taken out.
...
The chart shows that the more rural a district is the lower the percentage of individuals that have meaningful employment in the region two and seven years after graduating high school.
