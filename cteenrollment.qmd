...
The tables below show that the average number of CTE courses taken by all PersonID in the master dataset is 2.22 with a standard deviation of +/-2.33. This is a high standard deviation meaning there are values quite far from the mean.

The second row of the table shows the average number of CTE courses taken by individuals who took at least one CTE course. The average jumps up a bit to 3.15 with a standard deviation of 2.19.
...
The table below shows that a third of all graduates took a CTE course in Transportation, Distribution & Logistics, followed by 19% in Manufacturing, and 15% in each Architecture & Construction and Human Services.
