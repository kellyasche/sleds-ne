...
```{r ap original data}
ap.original <- read_csv('/Users/kellyasche/Library/CloudStorage/GoogleDrive-kasche@ruralmn.org/My Drive/Research/FY25-27/FY27/OHE Journey to meaningful employment/Data/SLEDS/AP/AdvancedPlacementSATPSAT_AP.csv') %>%
...
From the table below we can see that out of the total observations in our dataset, 8.7% have taken an AP exam.
...
Interestingly, there was significant difference between the percentage of students who took an AP exam by their RUCA categories. Although, nearly 10% of all students took the AP exam, only 3.1% from town/rural mix districts took the exam compared to 6.7% from our entirely rural districts and 10.8% from our urban/town/rural mix districts.
...
There is significant variation in the percent of students who've taken an AP exam across counties. It ranges from 0.1% in Aitkin to 28.1% in Cook County.
