...
numeric.var.names <- master.original %>%
  select(n.years.attended, ACTCompositeScore, total.cte.courses.taken, `ACTE.SPED`:MCA.S, n.institutions, ps.grad.in.same.ruca, ps.grad.in.same.edr, ps.grad.in.MN, avg.unemp.rate, avg.wages.pct.state) %>%
  names()
