...
updated.master <- master.original %>%
  ...
  mutate_at(vars(range.school:ps.grad.in.MN), as.factor) %>%
...
-   Range graduates were significantly less likely to have meaningful employment in the region and in MN.
-   Range graduates were significantly more likely to not have a MN employment record.
...
-   Range schools were significantly more likely to have graduates attend post-secondary.
-   Range schools were a bit less likely to not have a MN employment record.

Five years after graduating

-   Range schools were slightly less likely to have meaningful employment in region.
-   Range graduates were slightly less likely to have meaningful employment in MN.
-   Range graduates were slightly more likely to be attending post-secondary.
-   Range graduates were significantly less likely to not have meaningful employment.
-   Range graduates were significantly more likely to not have a MN employment record.

Ten years after graduating

-   Range graduates were slightly less likely to have meaningful employment in region.
-   Range graduates were significantly less likely to not have meaninful employment in MN.
-   Range graduates were significantly more likely to not have a MN employment record.
                                   ...
                                   ifelse(ps.grad.in.same.edr == "Outside EDR" & ps.grad.in.MN == "In Minnesota", "In state",
                                          ifelse(ps.grad.in.same.edr == "Inside and outside same EDR" & ps.grad.in.MN == "In Minnesota", "In state",
                                                 ifelse(ps.grad.in.MN == "Outside MN", "Outside Minnesota",
                                                        ifelse(ps.grad.in.same.edr == "Inside and outside same EDR", "Inside and outside region",
                                                        ifelse(ps.grad.in.MN == "Inside and outside MN", "Inside and outside MN", as.character(ps.grad.in.MN)))))))) %>%
  select(PersonID, grad.year.covid, economic.status, range.school, pseo.participant, SpecialEdStatus, RaceEthnicity, Dem_Desc, took.ACT, cte.achievement, english.learner, ps.grad, ps.grad.InstitutionSector, highest.cred.level, ps.grad.location, ACTCompositeScore, MCA.M, MCA.R, MCA.S, total.cte.courses.taken,grad.year.1, grad.year.5, grad.year.10)
