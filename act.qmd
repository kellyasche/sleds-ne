...
```{r act original data}
act.original <- read_csv('/Users/kellyasche/Library/CloudStorage/GoogleDrive-kasche@ruralmn.org/My Drive/Research/FY25-27/FY27/OHE Journey to meaningful employment/Data/SLEDS/ACT/ACT.csv') %>%
...
The table below shows that 43% of graduates from Northeast Minnesota have taken the ACT at some point in the dataset.
...
Finally, here's a look at the percentages by county. The largest percentage comes from Cook County with only 66.4% of graduates taking the ACT. The lowest was in Itaska County with 52.0%.
